...
%   Zhang, T. and Tomasi, C. (2002). On the Consistency of Instantaneous 
%       Rigid Motion Estimation. International Journal of Computer Vision, 
%       46(1):51-79.
...
for ii = 1:gnInitNum,
    ...
    for it= 1:gnMaxIter,
        ...
        [Vel, dVel] = estTranslationGN(flow, W, f, newMotion(Vel,Omega), InvZ, 2);
